...
Thirteen distinct `git_sha` values are recorded across the committed result
...
| `9f7681169d8b` | `magnitude/validity_map.json` | yes (ancestor of HEAD) | P-VALIDITY-MAP v1 run (2026-09-14) |
...
thirteen artifacts remain byte-for-byte as committed and are pinned by
