...
BINDINGS = [
    ...
    (C, "5.235", "bcmp",
     lambda j: j["oi"]["14"]["median_ang_by_unit"]["dc05_active"], 3),
    (E, "5.235", "bcmp",
     lambda j: j["oi"]["14"]["median_ang_by_unit"]["dc05_active"], 3),
    (C, "2.894", "bcmp",
    ...
    (E, f"{U}0.615", "bcmp",
     ...
     ["dc05_active_vs_randomA48"], 3),
    (C, "0.474", "bcmp",
     lambda j: j["diligent"]["28"]["median_dev_from"]
     ["informed_vs_randomA48"], 3),
    (E, "6.686", "bcmp",
     lambda j: j["diligent"]["28"]["median_ang_by_unit"]["dc05_active"], 3),
